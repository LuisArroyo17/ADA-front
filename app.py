...
app = Flask(__name__)
app.secret_key = 'your_secret_key'  # Clave necesaria para usar sesiones
...
def registrarse():
    if request.method == 'POST':
        ...
        # Simula el almacenamiento del usuario
...
# Ruta para elegir el lenguaje de programación
...
# Ruta para elegir el número de códigos a subir
...
# Ruta para mostrar la comparación de tiempos y gráficos
...
def comparacion_vista():
    ...
    if request.method == 'POST':
        ...
        # Procesa los códigos y determina los tiempos de ejecución
